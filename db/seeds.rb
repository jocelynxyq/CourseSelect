...
class StudentGenerator
  ...
  DEPARTMENT= %w(计算机与控制学院 软件研究所 计算机技术研究所 自动化研究所 计算机网络信息中心 信息工程研究所)
...
Notice.create!([
  {user_id: nil, title: "2017-2018学年春季学期预计开课统计", content: "各位同学：    \n春季学期各院（系、中心）预计开课信息现予以发布，同学们可根据秋季学期已经开课和春季学期预计开课情况统筹安排自己的选课。     \n"},
  {user_id: nil, title: "英语B课程怀柔班级增容通知", content: "为满足集中教学学生选课需求，英语B课程怀柔班级每班容量由35人增加至38人。选课时间为2017年1月13日中午12：30。    \n特此通知。     \n"},
  {user_id: nil, title: "2017-2018秋季学期课程考试时间安排", content: "http://jwjz.ucas.ac.cn/Student/Public/ShowExamInfo.aspx    \n"},
  {user_id: nil, title: "英语B课程增容通知", content: "经研究决定，怀柔英语B班级增容至38人，中关村和玉泉路英语B班级增容至35人。选课时间为9月15日（周五）12:30。并作如下说明：    \n1.本轮选课结束后，不再增容；    \n2.英语B是博士必修课程，因资源有限，建议不考虑转博的硕士将资源留给博士生修读；    \n3.春季学期的英语B容量很多，足够满足大家的修读需求，所以本轮选不上课的同学，请选择参加本学期末的英语B免修考试或者在春季学期修读；    \n4.英语B免修考试在每年的5月和11月份组织报名，请关注外语系网站通知。普博生、通过英语A的学术型硕士和直博生可以参加英语B免修考试。    \n"},
])
...
course_map={
    1 => {course_code: "091M4001H", name: "计算机体系结构", course_type: "专业核心课", credit: "60/3.0", limit_num: "", course_week: "第2-20周", course_time: "周一(9-11)", class_room: "教1-107", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试", outline:"本课程为计算机科学与技术学科研究生的专业核心课。本课程重点论述计算机系统的各种基本结构、设计技术和性能分析方法。课程的目的及任务是：使学生通过本课程的学习，了解计算机系统的各种基本结构。"},
...
(1..200).each do |index|
  ...
  course_array=(1..34).to_a.sort { rand() - 0.5 }[1..rand(4..7)]
